...
sport_car = SportCar(240, 'Черная', 'Спортивна машина', False)
town_car = TownCar(140, 'синяя', 'Городская машина', False)
work_car = WorkCar(90, 'Красная', 'Рабочая машина', False)
police_car = PoliceCar(210, 'Белая', 'Полицейская машина', True)
